...
const DropdownMenuTriggerFixed = DropdownMenuPrimitive.Trigger
...
DropdownMenuSubTriggerFixed.displayName = DropdownMenuPrimitive.SubTrigger.displayName
...
DropdownMenuSubContentFixed.displayName = DropdownMenuPrimitive.SubContent.displayName
...
DropdownMenuCheckboxItemFixed.displayName = DropdownMenuPrimitive.CheckboxItem.displayName
...
const DropdownMenuShortcutFixed = ({ className, ...props }: React.HTMLAttributes<HTMLSpanElement>) => {
